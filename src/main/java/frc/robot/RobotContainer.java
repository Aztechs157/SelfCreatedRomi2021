...
public class RobotContainer {
   ...
   */
  private SequentialCommandGroup generateRamseteCommand() {
    var autoVoltageConstraint = new DifferentialDriveVoltageConstraint(
        new SimpleMotorFeedforward(DriveConstants.ksVolts, DriveConstants.kvVoltSecondsPerMeter,
            DriveConstants.kaVoltSecondsSquaredPerMeter),
        DriveConstants.kDriveKinematics, DriveConstants.kVoltMax);
    ...
    final Trajectory exampleTrajectory;
    ...
    exampleTrajectory = tempTrajectory;
    ...
    RamseteCommand ramseteCommand = new RamseteCommand(
      ...
      return new InstantCommand(() -> m_drivetrain.resetOdometry(exampleTrajectory.getInitialPose()), m_drivetrain)
          ...
          // next, we reset the gyro
          .andThen(new InstantCommand(() -> m_drivetrain.resetGyro()))
