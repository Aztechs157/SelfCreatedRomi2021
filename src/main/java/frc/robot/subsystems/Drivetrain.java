...
public class Drivetrain extends SubsystemBase {
  ...
  private static final double kWheelDiameterMeter = 0.07; // 70 mm    2.75591 inches
  ...
  // Used for tracking drive train
  private final DifferentialDriveOdometry m_odometry;

  // Shows a field diagram and provides a position
  ...
  public void periodic() {
    ...
    // m_odometry.update(new Rotation2d(), m_leftEncoder.getDistance(), m_rightEncoder.getDistance());
  ...
  // Gets the pose of drivetrain
  public Pose2d getPose() {
    return m_odometry.getPoseMeters();
  }

  // Finds the current wheel speed
  ...
  // Resets the "Heading" and is a fancy word for direction
